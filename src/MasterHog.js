        ...
        return (
            <div>
                ...
                <ul className="hoglist">
                    <BabyHog eyeColor={this.state.eyeColor} hogData={this.state.hogData[0]} />
                    <BabyHog eyeColor={this.state.eyeColor} hogData={this.state.hogData[1]} />
                    <BabyHog eyeColor={this.state.eyeColor} hogData={this.state.hogData[2]} />
                </ul>
            </div>
        );
    }
